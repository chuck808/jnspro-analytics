...
Required GitHub CI on the final Phase 15 branch state verifies the implementation. The strict baseline is:
...
- production build: passing in required GitHub CI;
