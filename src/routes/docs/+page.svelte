...
<svelte:head>
	...
	<meta
		name="description"
		content="Complete documentation for AppGatePro Analytics — session analysis, goal tracking, performance trends, leaderboards, and more."
	/>
</svelte:head>
...
<div class="docs-container">
	<div class="docs-header">
		<h1>Documentation</h1>
		<p>
			Everything you need to understand your session data, set goals, track progress, and get the
