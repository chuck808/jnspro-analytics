	...
	{#if data.activeGoals && data.activeGoals.length > 0}
		<div class="themed-card">
			<div class="mb-4 flex items-center justify-between">
				...
				<a
					href="/goals"
					class="themed-text-secondary rounded text-xs transition-colors
						...
						<div class="mb-2 flex items-start justify-between">
							...
							<div class="ml-3 flex-shrink-0 text-right">
								...
								{:else if goal.daysUntilDeadline <= 7}
									<span class="rounded bg-[#f5a623]/10 px-2 py-0.5 text-xs text-[#f5a623]"
			...
			<a
				href="/goals"
				class="themed-nested-surface themed-border themed-text-secondary mt-4 flex min-h-[44px] items-center justify-center
                      gap-2 rounded-lg p-3
                      text-sm transition-all hover:border-[#f5a623]/20 hover:bg-[var(--theme-surface-hover)] hover:text-[#f5a623]
		...
		<div class="themed-card border-[#f5a623]/20 text-center">
			...
			<a
				...
				class="inline-flex min-h-[44px] items-center gap-2 rounded-lg bg-[#f5a623] px-6
                      py-3 text-sm font-semibold text-[#0a0809] transition-colors hover:bg-[#c97e0a]
						...
						{#each data.recentSessions as session}
							...
							>
								<div class="w-10 flex-shrink-0 text-center">
									<p class="text-sm font-bold text-[#f5a623]">
								...
								<svg
									class="themed-text-subtle h-4 w-4 flex-shrink-0 transition-colors group-hover:text-[#f5a623]"
									fill="none"
									stroke="currentColor"
									viewBox="0 0 24 24"
									aria-hidden="true"
					...
					<div class="space-y-2">
						{#each [{ href: '/upload', label: 'Upload Session', sub: 'Add more training data', amber: true, icon: 'M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12' }, { href: '/analytics', label: 'View Analytics', sub: 'Trends, charts & insights', amber: false, icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' }, { href: '/sessions', label: 'All Sessions', sub: `Browse all ${data.sessionCount} sessions`, amber: false, icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2' }] as action}
							...
							>
								...
								>
									<svg
										class="h-5 w-5 {action.amber ? 'text-[#f5a623]' : 'themed-text-secondary'}"
										fill="none"
										stroke="currentColor"
										viewBox="0 0 24 24"
										aria-hidden="true"
								...
								<svg
									class="h-4 w-4 flex-shrink-0 transition-colors
                                            {action.amber
										? 'text-[#f5a623]'
										: 'themed-text-subtle group-hover:text-[#f5a623]'}"
									fill="none"
									stroke="currentColor"
									viewBox="0 0 24 24"
									aria-hidden="true"
					...
					<div class="themed-card">
						...
						<div class="space-y-2 text-sm">
							<div class="flex items-center justify-between">
								...
								<span class="font-bold text-[#f5a623]"
