...
{#if isOpen}
    ...
    <div class="modal-backdrop" onclick={handleBackdropClick} onkeydown={handleKeyDown} role="button" tabindex="-1">
        <!-- svelte-ignore a11y_no_static_element_interactions -->
        <div class="modal-content" onclick={(e) => e.stopPropagation()} onkeydown={(e) => e.stopPropagation()} role="dialog" aria-modal="true" tabindex="0">
            {#if !isSuccess}
...
<style>
    .feedback-btn {
        ...
        box-shadow: 0 4px 12px rgba(245,166,35,0.3), 0 2px 4px rgba(0,0,0,0.2);
    ...
    .feedback-btn:hover {
        ...
        box-shadow: 0 6px 16px rgba(245,166,35,0.4), 0 4px 8px rgba(0,0,0,0.2);
    }
