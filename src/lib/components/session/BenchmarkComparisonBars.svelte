    ...
    <div class="themed-card rounded-xl p-5">
        <div class="mb-4">
            ...
            <p class="text-xs themed-text-subtle">
                See where you stand on each performance dimension
            </p>
        </div>
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-2">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-sm font-medium themed-text-primary">
                                    {dim.label}
                                </span>
                            </div>
                            <div class="flex items-center gap-2">
                        ...
                        <div class="relative h-8 rounded-lg overflow-hidden border border-[color:var(--border)]">
                            <!-- Background regions -->
                            ...
                            <!-- Region labels -->
                            <div class="absolute inset-0 flex items-center justify-around text-[10px] font-semibold opacity-50 pointer-events-none">
                        ...
                        <!-- Scale markers -->
                        <div class="flex justify-between mt-1 text-[10px] themed-text-subtle">
                            <span>0</span>
                            <span>25</span>
                            <span>50</span>
                            <span>75</span>
