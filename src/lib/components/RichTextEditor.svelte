...
<div class="bg-[#0a0809] border border-[#221c18] rounded-lg overflow-hidden">
    {#if editable}
        <!-- Toolbar -->
        <div class="flex items-center gap-1 px-2 py-2 border-b border-[#221c18] bg-[#131010]">
            <button
                onclick={toggleBold}
                type="button"
                class="px-2 py-1 rounded text-xs transition-colors
                       focus:outline-none focus:ring-2 focus:ring-[#f5a623]
                       {isBold ? 'bg-[#f5a623]/20 text-[#f5a623]' : 'text-[#9a8f7a] hover:bg-[#221c18]'}"
                title="Bold">
            ...
            <button
                ...
                class="px-2 py-1 rounded text-xs transition-colors
                       focus:outline-none focus:ring-2 focus:ring-[#f5a623]
                       {isItalic ? 'bg-[#f5a623]/20 text-[#f5a623]' : 'text-[#9a8f7a] hover:bg-[#221c18]'}"
                title="Italic">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
            ...
            <div class="w-px h-4 bg-[#221c18] mx-1"></div>
            ...
            <button
                ...
                class="px-2 py-1 rounded text-xs transition-colors
                       focus:outline-none focus:ring-2 focus:ring-[#f5a623]
                       {isBulletList ? 'bg-[#f5a623]/20 text-[#f5a623]' : 'text-[#9a8f7a] hover:bg-[#221c18]'}"
                title="Bullet list">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
            ...
            <button
                ...
                class="px-2 py-1 rounded text-xs transition-colors
                       focus:outline-none focus:ring-2 focus:ring-[#f5a623]
                       {isOrderedList ? 'bg-[#f5a623]/20 text-[#f5a623]' : 'text-[#9a8f7a] hover:bg-[#221c18]'}"
                title="Numbered list">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
            ...
            <button
                ...
                class="px-2 py-1 rounded text-xs font-semibold transition-colors
                       focus:outline-none focus:ring-2 focus:ring-[#f5a623]
                       {editor?.isActive('heading', { level: 2 }) ? 'bg-[#f5a623]/20 text-[#f5a623]' : 'text-[#9a8f7a] hover:bg-[#221c18]'}"
                title="Heading">
                H2
            </button>
            ...
            <button
                ...
                class="px-2 py-1 rounded text-xs font-semibold transition-colors
                       focus:outline-none focus:ring-2 focus:ring-[#f5a623]
                       {editor?.isActive('heading', { level: 3 }) ? 'bg-[#f5a623]/20 text-[#f5a623]' : 'text-[#9a8f7a] hover:bg-[#221c18]'}"
                title="Subheading">
                H3
            </button>
        </div>
