...
>
	...
	<div class="mb-4 flex items-start justify-between">
		<div class="flex-1">
			...
			<p class="mt-1 text-sm text-[#9a8f7a]">{metric}</p>
		</div>
		{#if progressStatus}
			<div class="flex items-center gap-2">
				<span class="text-2xl">{statusEmoji}</span>
				<div class="text-right">
					<p class="text-xs font-medium tracking-wide uppercase" style="color: {statusColor}">
	...
	<!-- Progress Bar -->
	<div class="mb-4">
		<div class="h-2 overflow-hidden rounded-full bg-[#221c18]">
			<div
	...
	{#if prediction}
		<div class="border-t border-[#221c18] pt-4">
			<div class="mb-2 flex items-center justify-between">
				<p class="text-xs tracking-wide text-[#6b5f4d] uppercase">AI Prediction</p>
				<span class="rounded-full bg-[#f5a623]/10 px-2 py-1 text-xs text-[#f5a623]">
					{prediction.type}
				</span>
			</div>
			...
			{#if prediction.sessionsRemaining !== null}
				...
				{#if prediction.confidenceInterval}
					<div class="mb-2 flex items-center gap-2">
						<div class="relative h-1 flex-1 rounded-full bg-[#221c18]">
							<div
								class="absolute h-full rounded-full bg-[#f5a623]/30"
								style="left: 0%; width: 100%"
							></div>
							<div
								class="absolute h-full rounded-full bg-[#f5a623]"
	...
	{#if daysRemaining !== null}
		<div class="mt-4 border-t border-[#221c18] pt-4">
			<div class="flex items-center justify-between text-xs">
				...
				<span class="font-medium text-[#9a8f7a]">
