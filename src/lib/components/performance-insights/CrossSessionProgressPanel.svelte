			...
			{#each keyInsights as insight}
				<div class="insight-card">
					<div class="insight-header">
						...
						<span class="insight-status" style="color: {trendStatusColor(insight.trend.improving)}">
					...
					{#if detailLevel === 'elite' || detailLevel === 'coach'}
						<div class="insight-detail">
							<span class="detail-value"
								>Recent: {insight.trend.recent?.toFixed(insight.decimals) ?? '—'}</span
							>
