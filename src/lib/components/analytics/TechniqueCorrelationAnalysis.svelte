...
<div class="themed-card rounded-xl p-5">
	<div class="mb-4">
		<h3 class="themed-text-primary mb-2 text-base font-bold">Technique Dimension Relationships</h3>
				...
				<div class="themed-nested-card rounded-lg p-4">
					<div class="mb-2 flex items-center justify-between">
						<div class="flex items-center gap-2">
							...
							<span class="themed-text-primary text-sm font-semibold">
					...
					<!-- Strength indicator -->
					<div class="mt-2 h-1 w-full overflow-hidden rounded-full bg-[color:var(--card)]">
						<div
							class="h-full rounded-full transition-all"
							style="width: {corr.strength * 100}%; background-color: {color};"
						></div>
					</div>
				</div>
			{/each}
