...
export function buildEnhancedRecommendations(report: CrossSessionReport): EnhancedRecommendation[] {
	...
	const gapWidening =
		report.consistency.bestVsAverageGapTrend.direction === 'up' &&
	...
	if (
		report.fatigue.optimalSetLengthTrend.direction === 'stable' &&
