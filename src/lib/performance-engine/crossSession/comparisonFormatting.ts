...
export function formatMetricComparison(
	...
	const isImproving = options.direction === 'higher-is-better' ? rawChange > 0 : rawChange < 0;
...
export function formatReactionComparison(
	oldSec: number | null,
	newSec: number | null
): FormattedComparison | null {
...
export function formatConsistencyComparison(
