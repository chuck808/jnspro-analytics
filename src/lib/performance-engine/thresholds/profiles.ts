  ...
  grom: {
    ...
    metrics: {
      reactionTimeMs: {
        ...
        notes: 'Starter thresholds only. Keep grom feedback encouraging and avoid over-focusing on reaction time.'
      },
      peakSpeedKmh: {
        excellent: 35,
        good: 28,
  ...
  elite: {
    ...
    metrics: {
      reactionTimeMs: {
        ...
        direction: 'lower-is-better',
        confidence: starterConfidence,
        notes: 'Starter elite thresholds. Real competition timing systems may differ from device detection.'
      },
      peakSpeedKmh: {
        excellent: 58,
        good: 50,
...
export function getThresholdProfile(level: 'grom' | 'rider' | 'elite' | 'coach' = 'rider'): BMXThresholdProfile {
