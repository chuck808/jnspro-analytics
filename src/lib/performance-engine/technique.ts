...
function buildPhaseAssessment(
	...
	if (explosiveness > 80 && smoothness > 75 && efficiency > 75)
		return 'Strong launch, smooth transition and good speed carry.';
	if (explosiveness > 80 && efficiency < 65)
		return 'Explosive launch, but speed carry could improve after the first phase.';
	if (explosiveness < 65 && smoothness > 75)
		return 'Smooth run, but the first drive phase needs more force.';
