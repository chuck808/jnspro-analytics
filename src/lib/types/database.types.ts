...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      coach_rider_messages: {
        Row: {
          content: string
          created_at: string
          flagged_field: string | null
          id: string
          link_id: string
          message_type: string
        ...
        Relationships: [
          {
            foreignKeyName: "coach_rider_messages_link_id_fkey"
            columns: ["link_id"]
            isOneToOne: false
            referencedRelation: "coach_rider_links"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      profiles: {
        Row: {
          ...
          parental_consent_requested_at: string | null
      ...
      report_shares: {
        ...
        Relationships: [
          {
            foreignKeyName: "report_shares_link_id_fkey"
            columns: ["link_id"]
            isOneToOne: false
            referencedRelation: "coach_rider_links"
            referencedColumns: ["id"]
